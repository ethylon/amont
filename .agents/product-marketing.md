...
- Opaque: the GUI does _something_ to your repo and you're never sure what.
...
| "Windows only?"             | Yes, deliberately — it's built _for_ Windows rather than ported to it. macOS/Linux later.                            |
...
- "I just want to _see_ my branches without lag."
